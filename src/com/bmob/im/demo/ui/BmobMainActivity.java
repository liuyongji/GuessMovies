 ...
 */
public class BmobMainActivity extends ActivityBase implements EventListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_bmob);
...
//		refreshNewMsg(message);
	...
	private void refreshNewMsg(BmobMsg message){
		...
		//也要存储起来
		if(message!=null){
			BmobChatManager.getInstance(BmobMainActivity.this).saveReceiveMessage(true,message);
		}
